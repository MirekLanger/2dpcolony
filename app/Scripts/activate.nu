...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\data\personal\vsb\projekty\aco_simulator\app'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\data\personal\vsb\projekty\aco_simulator\app\Scripts\deactivate.nu'
